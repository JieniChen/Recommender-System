...
- [Comparision of all the algorithms used above](#comparision-of-all-the-algorithms-used-above)
  - [fold-2](#fold-2)
  - [fold-3](#fold-3)
- [Mean Value Comparision](#mean-value-comparision)
- [Compare cosine, MSD, Person Similarities](#compare-cosine-msd-person-similarities)
- [How the number of neighbors impacts the performances](#how-the-number-of-neighbors-impacts-the-performances)
- [Reference](#reference)
